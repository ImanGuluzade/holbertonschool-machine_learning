...
def projection_block(A_prev, filters, s=2):
    ...
    s: stride of the first convolution in both main path and shortcut connection
    ...
    # --- First Layer Components (Main Path) ---
    ...
    # --- Second Layer Components (Main Path) ---
    ...
    # --- Third Layer Components (Main Path) ---
    ...
    # --- Shortcut Path ---
    # Projection layer mapping dimensions and channels to match the output
    ...
    # --- Combined Paths ---
    merged = K.layers.Add()([bn3, shortcut_bn])
